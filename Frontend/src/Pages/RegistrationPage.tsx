...
import { ChefHat, Eye, EyeOff, User, Mail, Lock, ArrowLeft } from "lucide-react";
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // If backend sent array of errors
        if (Array.isArray(data)) {
          setRegisterError(data.join(", "));
        } else {
          ...
          <div className="w-full max-w-md">
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 shadow-black/20">
              <div className="text-center mb-8">
                ...
                <p className="text-white/80 drop-shadow">Join Foodify and start your culinary journey.</p>
              </div>
              ...
              <form onSubmit={handleRegister} className="space-y-6">
                ...
                <div>
                  ...
                  {nameError && (
                    <p className="text-red-400 text-sm mt-1 drop-shadow">{nameError}</p>
                  )}
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="terms" className="text-white/80 drop-shadow">
                      I agree to the{" "}
                ...
                {registerError && (
                  <div className="mt-3 p-3 bg-red-500/10 backdrop-blur-sm border border-red-500/30 rounded-lg">
                    <p className="text-red-400 text-sm text-center drop-shadow">{registerError}</p>
                  </div>
                )}
                ...
                <div className="mt-6">
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-transparent text-white/70 drop-shadow">Or Register With</span>
                    </div>
                  </div>
